...
register_operator("aten.arange.start", OperatorSpec(get_flops=_zeros_like_flops, get_memory=_zeros_like_memory))
register_operator("aten.arange.start_step", OperatorSpec(get_flops=_zeros_like_flops, get_memory=_zeros_like_memory))
register_operator("aten.zeros.default", OperatorSpec(get_flops=_zeros_like_flops, get_memory=_zeros_like_memory))
